...
from utiles.dataset_me import MeterDataset
...
class Trainer(object):
    ...
    def __init__(self):
        ...
        if os.path.exists('../weight/net_dian.pt'):
            self.net.load_state_dict(torch.load('weight/net_dian.pt', map_location='cpu'),False)
    ...
    def __call__(self):
        ...
        # running_tar_loss = 0
        save_frq = 120
        model_dir = '../weight/net_dian0001.pt'
        last_loss = []
