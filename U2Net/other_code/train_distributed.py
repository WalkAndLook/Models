...
class Trainer(object):
    ...
    def __init__(self):
        ...
        if torch.cuda.device_count() > 1:
            ...
            # 5) 封装
            self.net = torch.nn.parallel.DistributedDataParallel(self.net, device_ids=[local_rank], output_device=local_rank)
    ...
    def __call__(self):
        ...
        batch_size_val = 1
        ite_num = 0
        data_loader_train = DataLoader(self.data_set_train, batch_size_train, True)
